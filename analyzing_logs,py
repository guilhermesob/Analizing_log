'''
Analyze logs from applications, firewalls, operating systems, and more. test to interact with openAI api simple test
'''
...
# Read the diff from a file  ( especifi file )
